            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="row leftBarBlock">
                        <div class="row leftBarBlockHeader"><?=!empty($this->context->seoPage['html_1_header']) ? $this->context->seoPage['html_1_header'] : $this->context->settings['html_1_header'];?></div>
                        <div class="row leftBarText"><?=!empty($this->context->seoPage['html_1_text']) ? $this->context->seoPage['html_1_text'] : $this->context->settings['html_1_text'];?></div>
                    </div>
                    <div class="row leftBarBlock">
                        <div class="row leftBarBlockHeader"><?=!empty($this->context->seoPage['html_2_header']) ? $this->context->seoPage['html_2_header'] : $this->context->settings['html_2_header'];?></div>
                        <div class="row leftBarText"><?=!empty($this->context->seoPage['html_2_text']) ? $this->context->seoPage['html_2_text'] : $this->context->settings['html_2_text'];?></div>
                    </div>
                </div>
                <div class="col-md-8">
