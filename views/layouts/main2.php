        ...
        <div class="container mainWindow">
            ...
            <div class="row">
                ...
                <div class="col-md-4 logoHeader" onclick="window.location='/'">
                    <?=!empty($this->context->settings) ? $this->context->settings['site_name'] : 'Efir.cityt';?>
                </div>
                <div class="col-md-4">&nbsp;</div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 titleService">
                    <? if(!empty($this->context->seoPage)){ echo $this->context->seoPage['title'];}else{ ?>
                        <? if(!empty($this->context->settings)){ echo $this->context->settings['main_page_header'];}?>
                    <? } ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 threeTitleText">
                    <? if(!empty($this->context->settings)){ echo $this->context->settings['main_page_text'];}?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="row leftBarBlock">
                        <div class="row leftBarBlockHeader"><?=!empty($this->context->settings) ? $this->context->settings['html_1_header'] : '';?></div>
                        <div class="row leftBarText"><?=!empty($this->context->settings) ? $this->context->settings['html_1_text'] : '';?></div>
                    </div>
                    <div class="row leftBarBlock">
                        <div class="row leftBarBlockHeader"><?=!empty($this->context->settings) ? $this->context->settings['html_2_header'] : '';?></div>
                        <div class="row leftBarText"><?=!empty($this->context->settings) ? $this->context->settings['html_2_text'] : '';?></div>
                    </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-2">
                    ...
                    <div class="row rightBarBlock" style="text-align: center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 socialBlock socialBlockVk" data-url="<?=!empty($this->context->settings) ? $this->context->settings['vk'] : '';?>">
                            <div class="socialIcon">&nbsp;</div>
                            <span class="socialBlockTextVk">В</span>
                            <div style="margin: 0px; padding:0px;font-size: 10px;">Вконтакте</div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 socialBlock socialBlockFb" data-url="<?=!empty($this->context->settings) ? $this->context->settings['facebook'] : '';?>">
                            <div class="socialIcon">&nbsp;</div>
                            <span class="socialBlockTextFb">f</span>
                            <div style="margin: 0px; padding:0px;font-size: 10px;">Facebook</div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 socialBlock socialBlockOk" data-url="<?=!empty($this->context->settings) ? $this->context->settings['ok'] : '';?>">
                            <div class="socialIcon">&nbsp;</div>
